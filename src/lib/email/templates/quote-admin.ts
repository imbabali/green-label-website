      ...
      <td style="padding:30px;">
        ...
        <table width="100%" cellpadding="8" cellspacing="0" style="border-collapse:collapse;margin-bottom:20px;">
          <tr style="border-bottom:1px solid #e5e7eb;">
            ...
            <td style="color:#333;font-size:14px;">${data.serviceType}</td>
          </tr>
          <tr style="border-bottom:1px solid #e5e7eb;">
            <td style="color:#666;font-size:14px;"><strong>Location</strong></td>
            <td style="color:#333;font-size:14px;">${data.location}</td>
          </tr>
          ${data.frequency ? `<tr style="border-bottom:1px solid #e5e7eb;"><td style="color:#666;font-size:14px;"><strong>Frequency</strong></td><td style="color:#333;font-size:14px;">${data.frequency}</td></tr>` : ''}
          ${data.estimatedVolume ? `<tr style="border-bottom:1px solid #e5e7eb;"><td style="color:#666;font-size:14px;"><strong>Est. Volume</strong></td><td style="color:#333;font-size:14px;">${data.estimatedVolume}</td></tr>` : ''}
          ${data.timeline ? `<tr style="border-bottom:1px solid #e5e7eb;"><td style="color:#666;font-size:14px;"><strong>Timeline</strong></td><td style="color:#333;font-size:14px;">${data.timeline}</td></tr>` : ''}
          ${data.budgetRange ? `<tr style="border-bottom:1px solid #e5e7eb;"><td style="color:#666;font-size:14px;"><strong>Budget</strong></td><td style="color:#333;font-size:14px;">${data.budgetRange}</td></tr>` : ''}
        </table>
