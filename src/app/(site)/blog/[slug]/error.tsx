...
export default function BlogPostError({
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      ...
      <h2 className="mt-4 text-xl font-semibold text-gray-800">Could not load this article</h2>
      <p className="mt-2 max-w-md text-gray-600">
        We encountered an error while loading this blog post. Please try again or browse our other
        articles.
      </p>
