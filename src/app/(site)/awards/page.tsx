        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <ScrollRevealSection>
            <div className="flex gap-4 overflow-x-auto pb-2 hide-scrollbar snap-x snap-mandatory lg:grid lg:overflow-visible lg:pb-0 md:gap-6 lg:grid-cols-3">
              {awards.map((award, i) => (
                <div key={award.title} className={`min-w-[44vw] shrink-0 snap-start sm:min-w-[30vw] lg:min-w-0 lg:shrink reveal reveal-scale stagger-${i + 1} card-premium rounded-2xl border-b-4 border-b-amber-400 bg-white p-4 md:p-6 text-center shadow-md`}>
