    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-green py-12 md:py-16">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <ScrollRevealSection>
            <h2 className="reveal reveal-up mb-2 text-center font-heading text-2xl font-bold text-white md:text-3xl"><i className="fa-solid fa-flask-vial mr-2 text-brand-orange-light" aria-hidden="true" />Our Capabilities</h2>
      ...
      <section className="relative overflow-hidden bg-gradient-green py-12">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center">
          <h2 className="font-heading text-xl font-bold text-white md:text-2xl"><i className="fa-solid fa-headset mr-2" aria-hidden="true" />Need a Waste Partner for Oil &amp; Gas?</h2>
