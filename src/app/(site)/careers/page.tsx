          ...
          <ScrollRevealSection>
            <div className="mt-12 flex gap-4 overflow-x-auto pb-2 hide-scrollbar snap-x snap-mandatory lg:grid lg:overflow-visible lg:pb-0 md:gap-6 lg:grid-cols-3">
              {benefits.map((b, index) => (
                <div key={b.title} className={`min-w-[70vw] shrink-0 snap-start sm:min-w-[45vw] lg:min-w-0 lg:shrink reveal reveal-up stagger-${Math.min(index + 1, 6)} card-premium rounded-2xl border-l-4 border-l-brand-green bg-white p-6 shadow-md`}>
