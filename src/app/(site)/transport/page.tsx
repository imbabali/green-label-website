...
const vehicleTypes = [
  { icon: 'fa-solid fa-truck-ramp-box', title: 'Compactor Trucks', description: 'High-capacity rear-loaders for general and commercial waste on scheduled routes.' },
  { icon: 'fa-solid fa-truck-droplet', title: 'Vacuum Tankers', description: 'Liquid waste, septic, and industrial sludge with metered pumps and spill containment.' },
  { icon: 'fa-solid fa-temperature-low', title: 'Medical Vehicles', description: 'Temperature-controlled vans with sealed compartments for infectious and sharps waste.' },
  { icon: 'fa-solid fa-truck-moving', title: 'Skip Loaders', description: 'Construction and bulky industrial waste — 6m³, 8m³, and 12m³ capacities.' },
  { icon: 'fa-solid fa-trailer', title: 'Roll-On / Roll-Off', description: 'Large-volume RORO containers for manufacturing, mining, and transfer stations.' },
  { icon: 'fa-solid fa-truck-field', title: 'Emergency Units', description: 'Rapid-deployment with spill kits, HAZMAT gear, and containment booms — 24/7.' },
]
    ...
    <>
          ...
          <ScrollRevealSection>
            <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
              {safetyFeatures.map((f, i) => (
                <div key={f.label} className={`reveal reveal-up stagger-${i + 1} card-premium flex items-center gap-2.5 rounded-xl bg-white p-3 shadow-sm`}>
      ...
      <section className="relative overflow-hidden bg-white py-12 md:py-16">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <ScrollRevealSection>
            <h2 className="reveal reveal-up mb-2 text-center font-heading text-2xl font-bold text-gray-900 md:text-3xl">Our Fleet</h2>
          ...
          <CardCarousel>
            {vehicleTypes.map((v) => (
              <div key={v.title} className="w-[75vw] max-w-[300px] shrink-0 snap-start">
      ...
      <section className="relative overflow-hidden bg-gradient-green py-12">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center">
          <h2 className="font-heading text-xl font-bold text-white md:text-2xl">Need Reliable Waste Transport?</h2>
